...
public class SettingsActivity extends Activity
{
    ...
    public static int getBitrateSetting(Context context)
    {
        ...
        String value_as_string = sharedPrefs.getString(SettingsActivity.BITRATE_KEY, Integer.toString(BITRATE_SETTINGS_AUTOMATIC));
    ...
    public static class SettingsFragment extends PreferenceFragment implements OnPreferenceChangeListener
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // String title =
            // getActivity().getResources().getString(R.string.settingsActivityTitle);
        ...
        void updateSummaryFromValue(Preference pref, String val)
        {
